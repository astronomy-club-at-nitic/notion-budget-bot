import type { CommandInteraction, MessageActionRowComponentBuilder, SelectMenuInteraction, Message } from 'discord.js';
...
export class Example {
  ...
  async handle(interaction: SelectMenuInteraction): Promise<Message<boolean>> {
